    ...
    <div className="min-h-screen bg-[#0a0a0f] overflow-hidden relative">
      ...
      <section className="relative py-24 lg:py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-slate-400 mb-10 max-w-3xl mx-auto leading-relaxed animate-fade-in-up delay-100">
          ...
          {/* Stats Row */}
          <div className="flex flex-wrap justify-center gap-8 text-sm animate-fade-in-up delay-300">
            {[
